    ...
    <UCard>
      <template #header>
        <div class="flex items-center justify-between">
          <h2 class="font-medium">{{ t('accountSettings.passkey.manager') }}</h2>
          <UButton
            size="lg"
            color="neutral"
            :loading="creating"
            ...
            @click="modal = true"
          >
            {{ t('accountSettings.passkey.addPasskey') }}
          </UButton>
        </div>
        <p class="mt-1 text-sm text-neutral-500">
          {{ t('accountSettings.passkey.description') }}
        </p>
      </template>
      ...
      <div v-else-if="status === 'success'">
        ...
        >
          ...
          <p>{{ t('accountSettings.passkey.noPasskeys') }}</p>
        </div>
        <ul class="divide-y divide-neutral-100 dark:divide-neutral-800">
          ...
          >
            ...
            >
              {{ t('accountSettings.passkey.delete') }}
            </UButton>
          </li>
        </ul>
      </div>
      ...
      <template #body>
        ...
        >
          ...
          <UButton
            ...
            :loading="creating"
            :disabled="creating"
            :label="t('accountSettings.passkey.createPasskey')"
            block
            size="lg"
            color="neutral"
          />
