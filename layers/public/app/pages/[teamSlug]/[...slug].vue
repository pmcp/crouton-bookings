...
/**
 * Main domain catch-all page handler.
 * Handles: crouton.com/acme/services/pricing
 *
 * Team from URL param, path from slug array.
 * Fetches page via by-path API.
 */
definePageMeta({
  layout: 'pages-main-domain',
})
