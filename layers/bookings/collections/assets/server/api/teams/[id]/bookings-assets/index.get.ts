...
import { getAllBookingsAssets, getBookingsAssetsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getBookingsAssetsByIds(team.id, ids)
  }

  return await getAllBookingsAssets(team.id)
})