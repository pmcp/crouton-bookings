...
import { getAllBookingsPages, getBookingsPagesByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getBookingsPagesByIds(team.id, ids)
  }

  return await getAllBookingsPages(team.id)
})